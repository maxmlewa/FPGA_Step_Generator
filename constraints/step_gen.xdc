...
# basys3_220.xdc
#
# This is a master constraints file
#
...
#-- pulse_in
set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { pulse_in }];
...
set_property -dict { PACKAGE_PIN G2   IOSTANDARD LVCMOS33 } [get_ports { step_out[0] }];
set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33 } [get_ports { step_out[1] }];
set_property -dict { PACKAGE_PIN L2   IOSTANDARD LVCMOS33 } [get_ports { step_out[2] }];
set_property -dict { PACKAGE_PIN H1   IOSTANDARD LVCMOS33 } [get_ports { step_out[3] }];
